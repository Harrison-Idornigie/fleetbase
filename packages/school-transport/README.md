...
A comprehensive Ember.js engine for managing school bus transportation, built as an extension to Fleetbase's Fleet-Ops module.

## Overview

The School Transport Engine provides a complete solution for managing student transportation, including:

- **Student Management**: Track student profiles, contact information, and special needs
- **Route Management**: Create, optimize, and track school bus routes
- **Assignment Management**: Assign students to routes with pickup/dropoff locations
- **Parent Portal**: Real-time bus tracking and notifications for parents
- **Safety & Compliance**: Driver certifications, vehicle inspections, and incident reporting
- **Communication**: Send notifications to parents via email, SMS, and push notifications
- **Reporting**: Generate attendance, route efficiency, and safety compliance reports
- **Real-time Tracking**: Live bus location tracking with ETA calculations
